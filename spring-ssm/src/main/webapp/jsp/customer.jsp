        ...
        <ul class="nav navbar-top-links navbar-right">
            <li class="dropdown"><a class="dropdown-toggle"
                ...
                <ul class="dropdown-menu dropdown-messages">
                    <li><a href="#">
                        <div>
                            <strong>人物</strong> <span class="pull-right text-muted">
									<em>时间</em>
								</span>
                        </div>
                        <div>地点...</div>
    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" action="${pageContext.request.contextPath }/customerList.action"
                      method="get">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="col-md-12 text-right">
                        <abyg:page url="${pageContext.request.contextPath }/customerList.action"/>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
